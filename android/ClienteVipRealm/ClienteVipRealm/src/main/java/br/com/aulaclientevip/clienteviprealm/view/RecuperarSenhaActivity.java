package br.com.aulaclientevip.clienteviprealm.view;
...
import br.com.aulaclientevip.clienteviprealm.R;
import br.com.aulaclientevip.clienteviprealm.controller.ClienteVipController;
...
public class RecuperarSenhaActivity extends AppCompatActivity {
    ...
    private ClienteVipController clienteVipController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTermos.setOnClickListener(view -> FancyAlertDialog.Builder
                ...
                .build()
                .show());
        List<ClienteVip> list = this.clienteVipController.list();
        for(ClienteVip c : list){
            Log.d("DEBUG", c.getNome() + " " + c.getEmail());
        }
        //teste de miggração
        ClienteVip clienteVip = new ClienteVip();
        clienteVip.setNome("Ada Ribeiro");
        clienteVip.setEmail("ada@teste.com.br");
        clienteVip.setIdade(0);
        this.clienteVipController.insert(clienteVip);
        Toast.makeText(RecuperarSenhaActivity.this, "###--INSERIDO--###", Toast.LENGTH_SHORT).show();
    }
    ...
    private void initFormulario() {
        ...
        this.clienteVipController = new ClienteVipController();
    }
