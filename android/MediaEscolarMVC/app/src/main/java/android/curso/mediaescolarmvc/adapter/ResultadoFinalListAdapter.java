...
import android.curso.mediaescolarmvc.util.AlterarAsyncTask;
...
public class ResultadoFinalListAdapter
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0,
                                ...
                                try {
                                    ...
                                    AlterarAsyncTask task =
                                            new AlterarAsyncTask(mediaEscolar,context);
    ...
    public View getView(int position,
        ...
        linha.txtMedia.setText(UtilMediaEscolar.formatarValorDecimal(mediaEscolar.getMediaFinal()));
